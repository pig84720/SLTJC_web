    ...
    return {
        list: [
            ...
            },
            {
                id: 'ui-time-from-to',
                config: {
                    template: {fromUrl: 'UITimeFromTo', base: true},
                    viewModel: {fromParams: 'UITimeFromTo', base: true}
                }
            },
            {
                id: 'ui-scoopmenu',
                config: {
                    template: {fromUrl: 'UIScoopMenu', base: true},
                    viewModel: {fromParams: 'UIScoopMenu', base: true}
                }
            },
            {
                id: 'ui-rubytabs',
                config: {
                    template: {fromUrl: 'UITabs', base: true},
                    viewModel: {fromParams: 'UITabs', base: true}
                }
            },
            {
                id: 'ui-sexy-radio',
                config: {
                    template: {fromUrl: 'UISexyRadio', base: true},
                    viewModel: {fromParams: 'UISexyRadio', base: true}
                }
            }
        ]
    };
